...
export const tenantPlanEnum  = pgEnum("tenant_plan",   ["demo", "pilot", "paid", "churned"]);
export const tenantStatusEnum = pgEnum("tenant_status", ["active", "inactive", "trial", "churned"]);
...
export const tenants = pgTable(
  "tenants",
  {
    ...
    // Pilot / billing fields
    plan:         tenantPlanEnum("plan").notNull().default("pilot"),
...
// ─── Invite Tokens ────────────────────────────────────────────────────────────
// Generated by Cameron in the admin panel. Sent to pilot customers.
// Clicking the link assigns their Clerk account to the pre-created tenant.
export const inviteTokens = pgTable(
  "invite_tokens",
  {
    ...
    email:      text("email"),                 // optional: pre-fill their signup email
  ...
  (t) => [
    ...
    index("invite_tokens_tenant_id_idx").on(t.tenantId),
  ],
);
